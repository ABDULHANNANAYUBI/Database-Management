...
CREATE TABLE customer_product (
    product_product_id   NUMBER(15) NOT NULL,
    customer_customer_id NUMBER(15) NOT NULL
);
...
CREATE TABLE employee (
    ...
    employee_adress      VARCHAR2(50),
    employee_phone       NUMBER(15),
    employee_email       VARCHAR2(100),
    store_store_id       NUMBER(15) NOT NULL
);
...
CREATE TABLE producer_category (
    category_category_id NUMBER(15) NOT NULL,
    producer_producer_id NUMBER(15) NOT NULL
);

ALTER TABLE producer_category ADD CONSTRAINT producer_category_pk PRIMARY KEY ( category_category_id,
...
CREATE TABLE store (
    ...
    store_adress VARCHAR2(50),
    store_phone  NUMBER(15),
...
ALTER TABLE producer_category
    ADD CONSTRAINT producer_category_category_fk FOREIGN KEY ( category_category_id )
        REFERENCES category ( category_id );

ALTER TABLE producer_category
    ADD CONSTRAINT producer_category_producer_fk FOREIGN KEY ( producer_producer_id )
        REFERENCES producer ( producer_id );

ALTER TABLE producer
    ADD CONSTRAINT producer_product_fk FOREIGN KEY ( product_product_id )
        REFERENCES product ( product_id );
